    ...
    <div>
      ...
      <div className="flex flex-wrap -mx-3 mb-2">
        <div className="w-full px-3 mb-6 md:mb-0">
          ...
          <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="alamatMeninggal" type="text" required placeholder="contoh: Jl. Melati no. 4" />
        </div>
      </div>
      <div className="flex flex-wrap -mx-3 mb-2">
        <div className="w-full px-3 mb-6 md:mb-0">
          <div className='flex flex-row gap-4'>
            <div className='flex flex-col'>
              ...
              <input name='tempatDikebumikan' type="text" required className='appearance-none block w-full p-4 bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500' />
            </div>
            <div className='flex flex-col'>

              <label htmlFor='tanggalDikebumikan' className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" >
                Tanggal Dikebumikan
              </label>
              <PatternFormat
                format='##/##/####'
                name='tanggalDikebumikan'
